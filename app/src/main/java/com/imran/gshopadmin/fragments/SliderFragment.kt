...
import com.imran.gshopadmin.databinding.FragmentSliderBinding
import java.util.*
...
class SliderFragment : Fragment() {
    ...
    private fun uploadImage(uri: Uri) {
       ...
       refStorage.putFile(uri)
            ...
            .addOnFailureListener {
                dialog.dismiss()
                Toast.makeText(requireContext(), "Something went wri]ong with storage", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun storeData(image: String) {
        ...
        db.collection("slider").document("item").set(data)
            .addOnSuccessListener {
                dialog.dismiss()
                Toast.makeText(requireContext(), "Slider Updat ed", Toast.LENGTH_SHORT).show()
            }.addOnFailureListener {
                dialog.dismiss()
